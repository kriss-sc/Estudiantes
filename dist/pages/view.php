...
<!doctype html>
    ...
    <title>AdminLTE v4 | Prueba</title>
    ...
    <div class="app-wrapper">
        ...
        <div class="app-content-header">
            ...
            <div class="row">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-md-6">
                        ...
                        <!--end::Header-->
                        <!--begin::Form-->
                        <form class="" method="POST" action="update.php" novalidate>
                            <!--begin::Body-->
                            <div class="card-body">
                            <!--begin::Row-->
                            <div class="row g-3">
            ...
            <input type="text" class="form-control" name="noTelefono" value="<?= $row['noTelefono']?>">
                                ...
                                <input type="text" class="form-control" name="direccion" value="<?= $row['direccion']?>"disabled>
                                ...
                                <input type="text" class="form-control" name="nivel" value="<?= $row['nivel']?>"disabled>
                                
                                <div class="invalid-feedback">Please provide a valid city.</div>
                                </div> 
                                <div class="col-md-6">
                                <label for="validationCustom01" class="form-label">Grado</label>
                                <input type="text" class="form-control" name="Grado" value="<?= $row['Grado']?>"disabled>
                                <div class="invalid-feedback">Please provide a valid city.</div>
                                </div>
                                <div class="col-md-6">
                                <label for="validationCustom01" class="form-label">Carrera</label>
                                <input type="text" class="form-control" name="Carrera" value="<?= $row['Carrera']?>" disabled>
                                
                                <div class="valid-feedback">Looks good!</div>
                                
                                <div class="valid-feedback">Looks good!</div>
                                <div class="col-md-6">
                                <label for="validationCustom05" class="form-label">Fecha Nacimiento</label>
                                <input
                                    type="date"
                                    class="form-control"
                                    id="validationCustom05"
                                    name="fechaNac"
                                    value="<?= $row['fechaNac']?>"disabled>
